<template>
  <template v-if="scheduleStore.isFetching">
    <div class="space-y-6">
      <!-- 頭像骨架屏 -->
      <div class="text-center mb-8">
        <div class="w-24 h-24 rounded-full bg-white/10 animate-pulse mx-auto mb-4"></div>
        <div class="h-6 w-32 bg-white/10 rounded mx-auto mb-2"></div>
        <div class="h-4 w-48 bg-white/10 rounded mx-auto"></div>
      </div>

      <!-- 按鈕骨架屏 -->
      <div class="space-y-4">
        <div v-for="i in 4" :key="i" class="glass-card w-full p-4 animate-pulse">
  ...
  <template v-else>
    ...
    <div class="mt-8">
      ...
      <!-- 中心載入中 -->
      <div v-if="scheduleStore.isFetching" class="space-y-3">
        <div v-for="i in 2" :key="i" class="glass-card p-4 animate-pulse">
      ...
      <!-- 中心列表 -->
      <div
        v-else-if="scheduleStore.centers.length > 0"
        class="space-y-3"
      >
        <div
          v-for="membership in scheduleStore.centers"
          :key="membership.id"
