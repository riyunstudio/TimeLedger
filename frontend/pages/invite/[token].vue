    ...
    <div class="relative w-full max-w-md">
      ...
      <div v-else-if="invitation" class="bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20">
        ...
        <div class="text-center mb-6">
          ...
          <template v-if="invitation.teacher_name">
            <h1 class="text-2xl font-bold text-white mb-1">{{ invitation.teacher_name }} 老師</h1>
            <p class="text-slate-400 mb-1">{{ invitation.center_name }} 邀請您加入</p>
          </template>
          <template v-else>
