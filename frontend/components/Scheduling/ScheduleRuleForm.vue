...
const getInitialValues = () => {
  if (props.editingRule) {
    ...
    return {
      ...
      start_date: props.editingRule.effective_from?.split(/[T ]/)[0] || formatDateToString(new Date()),
      end_date: props.editingRule.effective_to?.split(/[T ]/)[0] || '',
  ...
  (rule) => {
    if (rule) {
      ...
      setValues({
        ...
        start_date: rule.effective_from?.split(/[T ]/)[0] || formatDateToString(new Date()),
        end_date: rule.effective_to?.split(/[T ]/)[0] || null,
