...
type Offering struct {
	...
	CourseID            uint           `gorm:"type:bigint;not null;index" json:"course_id"`
	Name                string         `gorm:"type:varchar(255);not null" json:"name"`
	DefaultRoomID       *uint          `gorm:"type:bigint;index" json:"default_room_id"`
	DefaultTeacherID    *uint          `gorm:"type:bigint;index" json:"default_teacher_id"`
