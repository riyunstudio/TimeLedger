...
| `/teacher/profile` | 編輯個人檔案 | `GET /teacher/me/profile` (讀)<br>`POST /teacher/me/profile` (寫) | **❌ Missing GET** |
...
| `/admin/courses` | 課程/班別管理 | `GET /admin/centers/{id}/courses`<br>`POST/PUT/DELETE` | ✅ OK |
