...
-- 臺北市
-- -------------------------------------------------
INSERT INTO geo_cities (id, name) VALUES (1, '臺北市');
...
-- 新北市
-- -------------------------------------------------
INSERT INTO geo_cities (id, name) VALUES (2, '新北市');
INSERT INTO geo_districts (city_id, name) VALUES
...
-- 桃園市
-- -------------------------------------------------
INSERT INTO geo_cities (id, name) VALUES (3, '桃園市');
INSERT INTO geo_districts (city_id, name) VALUES
...
-- 臺中市
-- -------------------------------------------------
INSERT INTO geo_cities (id, name) VALUES (4, '臺中市');
INSERT INTO geo_districts (city_id, name) VALUES
(4, '中區'), (4, '東區'), (4, '南區'), (4, '西區'),
...
-- 臺南市
-- -------------------------------------------------
INSERT INTO geo_cities (id, name) VALUES (5, '臺南市');
INSERT INTO geo_districts (city_id, name) VALUES
...
-- 高雄市
-- -------------------------------------------------
INSERT INTO geo_cities (id, name) VALUES (6, '高雄市');
INSERT INTO geo_districts (city_id, name) VALUES
...
-- 基隆市
-- -------------------------------------------------
INSERT INTO geo_cities (id, name) VALUES (7, '基隆市');
INSERT INTO geo_districts (city_id, name) VALUES
...
-- 新竹市
-- -------------------------------------------------
INSERT INTO geo_cities (id, name) VALUES (8, '新竹市');
INSERT INTO geo_districts (city_id, name) VALUES
(8, '東區'), (8, '北區'), (8, '香山區');
...
-- 新竹縣
-- -------------------------------------------------
INSERT INTO geo_cities (id, name) VALUES (9, '新竹縣');
INSERT INTO geo_districts (city_id, name) VALUES
...
-- 苗栗縣
-- -------------------------------------------------
INSERT INTO geo_cities (id, name) VALUES (10, '苗栗縣');
INSERT INTO geo_districts (city_id, name) VALUES
...
-- 彰化縣
-- -------------------------------------------------
INSERT INTO geo_cities (id, name) VALUES (11, '彰化縣');
INSERT INTO geo_districts (city_id, name) VALUES
...
-- 南投縣
-- -------------------------------------------------
INSERT INTO geo_cities (id, name) VALUES (12, '南投縣');
INSERT INTO geo_districts (city_id, name) VALUES
...
-- 雲林縣
-- -------------------------------------------------
INSERT INTO geo_cities (id, name) VALUES (13, '雲林縣');
INSERT INTO geo_districts (city_id, name) VALUES
...
-- 嘉義市
-- -------------------------------------------------
INSERT INTO geo_cities (id, name) VALUES (14, '嘉義市');
INSERT INTO geo_districts (city_id, name) VALUES
(14, '東區'), (14, '西區');
...
-- 嘉義縣
-- -------------------------------------------------
INSERT INTO geo_cities (id, name) VALUES (15, '嘉義縣');
INSERT INTO geo_districts (city_id, name) VALUES
...
-- 屏東縣
-- -------------------------------------------------
INSERT INTO geo_cities (id, name) VALUES (16, '屏東縣');
INSERT INTO geo_districts (city_id, name) VALUES
...
-- 宜蘭縣
-- -------------------------------------------------
INSERT INTO geo_cities (id, name) VALUES (17, '宜蘭縣');
INSERT INTO geo_districts (city_id, name) VALUES
...
-- 花蓮縣
-- -------------------------------------------------
INSERT INTO geo_cities (id, name) VALUES (18, '花蓮縣');
INSERT INTO geo_districts (city_id, name) VALUES
...
-- 臺東縣
-- -------------------------------------------------
INSERT INTO geo_cities (id, name) VALUES (19, '臺東縣');
INSERT INTO geo_districts (city_id, name) VALUES
...
-- 澎湖縣
-- -------------------------------------------------
INSERT INTO geo_cities (id, name) VALUES (20, '澎湖縣');
INSERT INTO geo_districts (city_id, name) VALUES
...
-- 金門縣
-- -------------------------------------------------
INSERT INTO geo_cities (id, name) VALUES (21, '金門縣');
INSERT INTO geo_districts (city_id, name) VALUES
...
-- 連江縣
-- -------------------------------------------------
INSERT INTO geo_cities (id, name) VALUES (22, '連江縣');
INSERT INTO geo_districts (city_id, name) VALUES
...
-- 驗證資料
-- -------------------------------------------------
SELECT '城市數量:' AS info, COUNT(*) AS count FROM geo_cities;
SELECT '區域數量:' AS info, COUNT(*) AS count FROM geo_districts;
